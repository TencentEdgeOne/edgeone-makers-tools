...
description: >-
  ...
  (those don't run AI logic — use the matching EdgeOne Makers capability instead).
  Do NOT trigger for deployment workflows (use the deployment capability).
...
> Cross-reference: if your code uses `context.store` or KV APIs, also read `makers-storage.md`.

**Do NOT use for:**
- Plain Edge Functions / Cloud Functions / Middleware → use the matching capability
- Deployment workflows → use the deployment capability
...
3. Read the matching framework reference file for a copy-paste skeleton
4. Self-check against the **Twelve Red Lines**
5. Run through `makers-agents-review-checklist.md` before considering the work done
...
| Topic | Read |
|-------|------|
| Node entry (onRequest, context, AbortSignal) | [makers-agents-platform-node-entry.md](makers-agents-platform-node-entry.md) |
| Python entry (handler, ctx, asyncio.Event) | [makers-agents-platform-python-entry.md](makers-agents-platform-python-entry.md) |
| Environment variables + model convention | [makers-agents-platform-env-and-model.md](makers-agents-platform-env-and-model.md) |
| SSE streaming protocol | [makers-agents-platform-sse-protocol.md](makers-agents-platform-sse-protocol.md) |
| conversation-id dual-channel + frontend | [makers-agents-platform-conversation-id.md](makers-agents-platform-conversation-id.md) |
| agents/ vs cloud-functions/ separation | [makers-agents-platform-cloud-functions.md](makers-agents-platform-cloud-functions.md) |
| Store (context.store) | [makers-agents-capabilities-store.md](makers-agents-capabilities-store.md) |
| Sandbox (context.sandbox) | [makers-agents-capabilities-sandbox.md](makers-agents-capabilities-sandbox.md) |
| Tools (context.tools) | [makers-agents-capabilities-tools.md](makers-agents-capabilities-tools.md) |
| Claude Agent SDK (Node) | [makers-agents-node-frameworks-claude-sdk.md](makers-agents-node-frameworks-claude-sdk.md) |
| OpenAI Agents SDK (Node) | [makers-agents-node-frameworks-openai-agents.md](makers-agents-node-frameworks-openai-agents.md) |
| LangGraph (Node) | [makers-agents-node-frameworks-langgraph.md](makers-agents-node-frameworks-langgraph.md) |
| DeepAgents (Node) | [makers-agents-node-frameworks-deepagents.md](makers-agents-node-frameworks-deepagents.md) |
| Claude Agent SDK (Python) | [makers-agents-python-frameworks-claude-sdk.md](makers-agents-python-frameworks-claude-sdk.md) |
| OpenAI Agents SDK (Python) | [makers-agents-python-frameworks-openai-agents.md](makers-agents-python-frameworks-openai-agents.md) |
| LangGraph (Python) | [makers-agents-python-frameworks-langgraph.md](makers-agents-python-frameworks-langgraph.md) |
| DeepAgents (Python) | [makers-agents-python-frameworks-deepagents.md](makers-agents-python-frameworks-deepagents.md) |
| CrewAI (Python only) | [makers-agents-python-frameworks-crewai.md](makers-agents-python-frameworks-crewai.md) |
| Review checklist | [makers-agents-review-checklist.md](makers-agents-review-checklist.md) |
...
3. Walk through `makers-agents-review-checklist.md` from section A onward.
...
5. Get it running → self-check against the Critical Rules → run through `makers-agents-review-checklist.md`.
