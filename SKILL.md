...
description: >-
  EdgeOne Makers platform development skills — AI Agents (DeepAgents, LangGraph, Claude SDK, OpenAI Agents, CrewAI),
  Cloud Functions (Node.js, Go, Python), Edge Functions (V8), KV Storage, Middleware, Deployment, and CLI.
  Use when developing or deploying projects on EdgeOne Makers.
version: 1.0.0
metadata:
  author: EdgeOne
