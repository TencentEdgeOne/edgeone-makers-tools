...
⚠️ **Prerequisites**: You must enable KV Storage in the EdgeOne Makers console, create a namespace, and bind it to your project before using KV. See [makers-storage-kv.md](makers-storage-kv.md) for full setup instructions.
...
For full KV Storage API reference and usage guide, see: [makers-storage-kv.md](makers-storage-kv.md).
