...
See also:
- Route B (Claude Agent SDK): `makers-agents-node-frameworks-claude-sdk.md`
- Route C (OpenAI Agents SDK): `makers-agents-node-frameworks-openai-agents.md`
- Route D (LangGraph + DeepAgents): `makers-agents-node-frameworks-langgraph.md`
- Platform conventions: `makers-agents-platform-node-entry.md`
- Sandbox & tools: `makers-agents-capabilities-sandbox.md`
- Memory store: `makers-agents-capabilities-store.md`
- Review checklist: `makers-agents-review-checklist.md`
