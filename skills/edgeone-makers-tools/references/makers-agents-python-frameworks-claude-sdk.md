...
> Python runtime — see [makers-agents-platform-python-entry.md](makers-agents-platform-python-entry.md) for entry signature, ctx object, and SSE conventions.
...
- Node Route B: [makers-agents-node-frameworks-claude-sdk.md](makers-agents-node-frameworks-claude-sdk.md)
- Python runtime conventions: [makers-agents-platform-python-entry.md](makers-agents-platform-python-entry.md)
- Store API: [makers-agents-capabilities-store.md](makers-agents-capabilities-store.md)
- Sandbox: [makers-agents-capabilities-sandbox.md](makers-agents-capabilities-sandbox.md)
