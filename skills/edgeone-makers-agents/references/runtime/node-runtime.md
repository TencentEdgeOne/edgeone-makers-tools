...
> **Python runtime**: see [python-runtime.md](./python-runtime.md) for the Python-specific conventions (entry signature, `ctx` object, SSE, store API naming, blocking code handling).
